...
//  //TODO: reimplement going back and forward in folders s w
...
//    ImGui::Dummy(ImVec2(40.0f, 0.0f));
//    ImGui::SameLine();
//    ImGui::Text("Location: %s", m_currentFolder.getName().c_str());
//    ImGui::Separator();
//  }
//
//
//  // left of right side -- list of foldersw
//  ImGui::BeginChild("left pane", ImVec2(150, 0), true);
//  for(int i =0; i < m_currentFolder.getChildFolders().size(); i++){
//    if(ImGui::Button(HummingBirdCore::FolderUtils::getFolderName(m_currentFolder.getChildFolders()[i]).c_str())){
